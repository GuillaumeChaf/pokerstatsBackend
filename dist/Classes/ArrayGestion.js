...
class ArrayGestion {
    ...
    static splitArrayForStraight(cards) {
        const cardValued = [
            "A",
            "K",
            "Q",
    ...
    static removeCard(cardTable, card) {
...
exports.default = ArrayGestion;
//# sourceMappingURL=ArrayGestion.js.map