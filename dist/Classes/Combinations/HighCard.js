...
class HighCard {
    static calcul(combinationCard) {
        ...
        if (combinationCard[2] !== undefined)
            result += cardValued.indexOf(combinationCard[2][0].value) * 10000;
        if (combinationCard[3] !== undefined)
            result += cardValued.indexOf(combinationCard[3][0].value) * 100;
        if (combinationCard[4] !== undefined)
            result += cardValued.indexOf(combinationCard[4][0].value);
        return result;
    }
    ;
}
exports.default = HighCard;
